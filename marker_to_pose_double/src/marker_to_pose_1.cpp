...
{
  marker_sub = n.subscribe<aruco_msgs::MarkerArray>("/aruco_marker_publisher_1/markers", 10, &Marker2Pose::markerCallback, this);
  pose_pub = n.advertise<geometry_msgs::PoseStamped>("/aruco_marker_publisher_1/PoseStamped", 10);
  info_sub = n.subscribe<sensor_msgs::CameraInfo>("/camera1/color/camera_info",10, &Marker2Pose::infoCallback, this); //
  info_pub = n.advertise<sensor_msgs::CameraInfo>("/camera1/color/calibrated_camera_info",10); //
}  
...
void Marker2Pose::infoCallback(const sensor_msgs::CameraInfo::ConstPtr& msg)
{
  ...
  camera_info.K[0] = 620.5025;
  camera_info.K[2] = 318.4227;
  camera_info.K[4] = 623.1657;
  camera_info.K[5] = 249.0353;
  camera_info.P[0] = 620.5025;
  camera_info.P[2] = 318.4227;
  camera_info.P[5] = 623.1657;
  camera_info.P[6] = 249.0353;
